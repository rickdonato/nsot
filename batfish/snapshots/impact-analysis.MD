...
bf_fork_snapshot(BASE_SNAPSHOT_NAME, FAIL_SPINE1_SNAPSHOT_NAME, deactivate_nodes=["spine1"], deactivate_interfaces=[Interface('spine2', 'GigabitEthernet0/1')], overwrite=True)
